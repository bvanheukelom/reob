...
export default class Serializer {
    ...
    static init(){
        PersistenceAnnotation.getEntityClasses().forEach(function (c:TypeClass<Object>) {
                ...
                Object.defineProperty(c.prototype, propertyName, {
                    get: function ():any {
                        ...
                        if (Serializer.needsLazyLoading(this, propertyName)) {
                            var objectRetriever:ObjectRetriever = this["_objectRetriever"];
                            if (typeof v == "string") {
    ...
    static needsLazyLoading(object:Object, propertyName:string) {
        ...
        if( PersistenceAnnotation.isStoredAsForeignKeys(oc, propertyName ) )
        {
            ...
            if (shadowpropertyDescriptor)
                ...
                else if (PersistenceAnnotation.isArrayOrMap(oc, propertyName)) {
