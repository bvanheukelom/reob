...
var Serializer = (function () {
    ...
    Serializer.init = function () {
        PersistenceAnnotation_1.PersistenceAnnotation.getEntityClasses().forEach(function (c) {
            Serializer.installLazyLoaderGetterSetters(c);
        });
    };
    Serializer.installLazyLoaderGetterSetters = function (c) {
        PersistenceAnnotation_1.PersistenceAnnotation.getTypedPropertyNames(c).forEach(function (propertyName) {
            if (PersistenceAnnotation_1.PersistenceAnnotation.isStoredAsForeignKeys(c, propertyName)) {
    ...
    Serializer.needsLazyLoading = function (object, propertyName) {
        // TODO inheritance
        var oc = PersistenceAnnotation_1.PersistenceAnnotation.getClass(object);
        if (PersistenceAnnotation_1.PersistenceAnnotation.isStoredAsForeignKeys(oc, propertyName)) {
            ...
            if (shadowpropertyDescriptor)
                ...
                else if (PersistenceAnnotation_1.PersistenceAnnotation.isArrayOrMap(oc, propertyName)) {
    ...
    Serializer.prototype.toObjectRecursive = function (doc, parent, f) {
        ...
        if (f && typeof f["toObject"] == "function") {
            ...
            for (var propertyName in doc) {
                ...
                var isStoredAsKeys = PersistenceAnnotation_1.PersistenceAnnotation.isStoredAsForeignKeys(f, objectNameOfTheProperty);
        ...
        PersistenceAnnotation_1.setNonEnumerableProperty(o, "_objectRetriever", this.objectRetriever);
    ...
    Serializer.prototype.toDocumentRecursive = function (object, rootClass, parentObject, propertyNameOnParentObject) {
        ...
        if (!object || typeof object == "string" || typeof object == "number" || typeof object == "date" || typeof object == "boolean")
            ...
            if (typeof objectClass.toDocument == "function") {
                ...
                if (parentObject && propertyNameOnParentObject && PersistenceAnnotation_1.PersistenceAnnotation.isStoredAsForeignKeys(parentClass, propertyNameOnParentObject)) {
