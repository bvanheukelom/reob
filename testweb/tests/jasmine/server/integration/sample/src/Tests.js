...
describe("The persistence thing", function () {
    ...
    it("updates the collection", function (done) {
        personCollection.newPerson('bert', function (err, e) {
    ...
    it("can save foreign keys in a map", function (done) {
        treeCollection.newTree(12, onlyOnce(function (e, klaus) {
            treeCollection.newTree(13, onlyOnce(function (e, peter) {
                personCollection.newPerson("Held", onlyOnce(function (e, held) {
    ...
    it("uses persistence paths to return undefined for non existent subobjects ", function () {
        ...
        var pp = new omm.SerializationPath(new omm.ConstantObjectRetriever(1), "TestTree", "tree1");
        ...
        treeCollection.newTree(12, function (e, klaus) {
            treeCollection.newTree(13, function (e, peter) {
                personCollection.newPerson("Held", function (e, held) {
                    ...
                    held = personCollection.getById(held.getId());
                    var doc = new omm.Serializer(new omm.MeteorObjectRetriever()).toDocument(held);
                    expect(doc).toBeDefined();
    ...
    it("serializes local objects with arrays", function () {
        var s = new omm.Serializer(new omm.LocalObjectRetriever());
        var otherCar = s.toObject({ brand: "Monster", wheels: [{}, {}, {}, { radius: 12 }] }, Tests.TestCar);
        expect(otherCar).toBeDefined();
