...
function PrivateToServer(targetPrototypeObject, propertyName) {
...
exports.PrivateToServer = PrivateToServer;
/**
...
var PersistenceAnnotation = (function () {
    ...
    PersistenceAnnotation.isPrivateToServer = function (f, propertyName) {
        while (f != Object) {
