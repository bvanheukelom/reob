...
declare module omm {
    ...
    function collectionUpdate(t: omm.TypeClass<any>, functionName: string, options?: any): void;
    ...
    function arrayType(cls: TypeClass<Object>, propertyName: string, typeClassName: string): void;
    ...
    function idProperty(cls: TypeClass<Object>, propertyName: string): void;
